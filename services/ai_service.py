...
PROMPT_EXTRACAO_OFICIO = (
    ...
    "Separe obrigação escrita no Ofício de sugestão da IA.\n"
    "Se o órgão pedir informações até uma data, a sugestão pode dizer para "
    "preparar e encaminhar o que foi solicitado, observando o prazo indicado.\n"
    "Se a ação não estiver determinada, use linguagem condicional.\n"
    'Não escreva "Confirmar presença conforme solicitado" nem '
    '"Agendar a reunião" quando o documento não exigir isso.\n'
    'Prefira "Avaliar a participação e, se for o caso, confirmar presença" '
    'e "Caso haja participação, providenciar o registro do compromisso na '
    'agenda institucional".\n'
    "Convite, evento ou reunião pode sugerir comunicar os interessados, "
    "avaliar a participação do MPC-PB e, se houver interesse, confirmar e "
    "registrar o compromisso. Não afirme presença confirmada nem agendamento "
    "obrigatório.\n"
    "Solicitação prioriza avaliar ou providenciar o pedido, observar prazo "
    "indicado, preparar resposta ou reunir o que foi pedido.\n"
